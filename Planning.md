# Proposed CLI Usage
`thermite <plugin> [flags] [target]`

# Features
- schema maps
  - Map profiles to single output schema w/ toggle-able output values for streaming
- memory acquisition
  - stretch: make it live
...
### Address Space / Translation Layers
